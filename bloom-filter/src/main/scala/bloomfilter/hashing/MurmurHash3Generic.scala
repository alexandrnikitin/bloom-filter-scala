...
import bloomfilter.{Hash, CanGetDataFrom}
...
object MurmurHash3Generic {
  ...
  def murmurhash3_x64_128_pair[From](key: From, offset: Int, len: Int, seed: Int, outHash: Hash)(implicit cgdf: CanGetDataFrom[From]): Unit = {
    var h1: Long = seed & 0x00000000FFFFFFFFL
    var h2: Long = seed & 0x00000000FFFFFFFFL
